#!/usr/bin/env python3
"""Rewrite StubEngine.cpp using rust::String everywhere ModelInfo is stored."""

import pathlib

CONTENT = r'''// SPDX-License-Identifier: MIT OR Apache-2.0
//
...
// EngineState stores ModelInfo by-value. ModelInfo's fields are all
// ::rust::String, so the map key must also be ::rust::String.
...
p = pathlib.Path(r'C:\Users\steph\Desktop\Project_LlamaHarness\crates\llama-harness-ffi\cpp\StubEngine.cpp')
